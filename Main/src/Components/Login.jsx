...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f1f5f9] to-[#e2e8f0] text-[#1e293b] font-sans relative overflow-hidden">
  ...
  <span className="text-transparent bg-gradient-to-r from-[#06b6d4] to-[#0891b2] bg-clip-text">
    Login
            ...
            <div className="space-y-2 animate-field-entry animation-delay-100">
              <label htmlFor="email" className="text-md font-semibold text-[#1e293b]">
                Email
              </label>
              ...
              {errors.email && (
                <p className="text-red-500 text-sm animate-error-entry">{errors.email}</p>
              )}
            </div>

            {/* Password Field */}
            <div className="space-y-2 animate-field-entry animation-delay-200">
              <label htmlFor="password" className="text-md font-semibold text-[#1e293b]">
                Password
              </label>
              <div className="flex items-center bg-[#e2e8f0]/50 rounded-md px-3 py-2 transition-all duration-300 focus-within:ring-2 focus-within:ring-[#06b6d4]">
                <span className="text-lg mr-2 text-[#475569] hover:scale-110 hover:rotate-12 transition-transform duration-200">
              ...
              {errors.password && (
                <p className="text-red-500 text-sm animate-error-entry">{errors.password}</p>
              )}
            </div>

            {/* Backend Error */}
            {error && (
              <p className="text-red-500 text-sm animate-error-entry">{error}</p>
            )}
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#06b6d4] hover:bg-[#0891b2] text-white font-semibold py-2.5 rounded-md transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_15px_rgba(6,182,212,0.5)] animate-pulse-button relative overflow-hidden group"
            >
            ...
            <div className="flex items-center animate-divider-entry">
              ...
              <span className="px-3 text-[#475569] text-sm font-medium">or</span>
              <div className="flex-grow h-px bg-[#e2e8f0] animate-line-grow"></div>
            </div>
            ...
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center gap-3 py-2.5 bg-[#ffffff]/90 hover:bg-[#ffffff]/100 text-[#1e293b] rounded-md font-semibold transition-all duration-300 transform hover:scale-105 hover:shadow-[0_0_10px_rgba(6,182,212,0.3)] group"
            >
